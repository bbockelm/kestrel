...
setup(name='kestrel',
      version='0.2',
      scripts=['src/gfactory_entry_requests', 'src/gfactory_frontend_groups', 'src/gfactory_frontend_info', 'src/gwms_analyze_job', 'src/kestrel_config_val', 'src/kestrel_unzip_log', 'src/gwms_compare_collectors'],
